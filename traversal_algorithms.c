...
// Traversals
// ----------------------
void preorder_traversal(root *r) {
    if (r != NULL) {
        printf("%d ", r->value);
        preorder_traversal(r->left_child);
        preorder_traversal(r->right_child);
    }
}

void inorder_traversal(root *r) {
    if (r != NULL) {
        inorder_traversal(r->left_child);
        printf("%d ", r->value);
        inorder_traversal(r->right_child);
    }
}
...
// ----------------------
int main() {
    root *r = create_node(10);
    r->left_child = create_node(20);
    r->left_child->left_child = create_node(40);
    r->left_child->right_child = create_node(50);
    r->right_child = create_node(30);
    r->right_child->left_child = create_node(60);
